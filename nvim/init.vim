...
set cursorline
set number
set wildignore+=*/tmp/*,*/target/*,*.so,*.swp,*.zip,*/_build/*,*/node_modules/*,*/.git/*,*/deps/*
...
autocmd BufNewFile,BufReadPost Jenkinsfile setlocal filetype=groovy
...
let g:ale_linters = {'rust': ['analyzer', 'clippy'], 'yaml': ['yamllint']}
let g:ale_fixers = {'rust': ['rustfmt'], 'elixir': ['mix_format'], 'python': ['black'], 'javascript': ['prettier']}
